...
public abstract class ReservationMapper {
    @Mappings({
            @Mapping(target = "fechaInicio", source = "reservationDTO.fechaInicio", dateFormat = "dd-MM-yyyy"),
            @Mapping(target = "fechaFin", source = "reservationDTO.fechaFin", dateFormat = "dd-MM-yyyy"),
    ...
    @Mapping(target = "fechaInicio", dateFormat = "dd-MM-yyyy")
    @Mapping(target = "fechaFin", dateFormat = "dd-MM-yyyy")
